...
LastEditTime: 2021-03-01 17:39:18
...
def muggle_call_back():
    ...
    print('===========\n\order_id: MugglePay order ID\n{}\n==========='.format(callback_info['order_id']))
    print('===========\n merchant_order_id: Order ID of the merchant. Should be used to identify order or invoice.\n\
        {}==========='.format(callback_info['merchant_order_id']))
    print('===========\n status: MugglePay payment status.\n\
        {}==========='.format(callback_info['status']))
    print('===========\n price_amount: The price set by the merchant; Example: 9.99\n\
        {}\n==========='.format(callback_info['price_amount']))
    print('===========\n price_currency: Currency in which the merchant\'s goods/services are priced; Example: USD\n\
        {}\n==========='.format(callback_info['price_currency']))
    print('===========\n created_at: Invoice creation time; Example: \'2019-04-24T17:23:54.311Z\'\n\
        {}\n==========='.format(callback_info['created_at']))
    print('===========\n created_at_t: Your token provided by CreateOrder to validate Payment Callback\n\
    ...
    print('===========\n token: Your token provided by CreateOrder api to validate Payment Callback.\n\
        {}\n==========='.format(callback_info['token']))
    print('===========\n meta: Option: provide third party information. e.g. Alipay or WechatPay. An example of Alipay is provided as example.\n\
